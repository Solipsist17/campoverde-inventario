        ...
        <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseUsuarios" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="SvUsuarios">Consultar Usuarios</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseProductos" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Acciones:</h6>
                        <a class="collapse-item" href="SvProductos">Consultar Productos</a>
                        <a class="collapse-item" href="SvDatosProductos">Registrar Producto</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseVentas" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Acciones:</h6>
                        <a class="collapse-item" href="consultar-ventas.jsp">Consultar Ventas</a>
                        <a class="collapse-item" href="registrar-venta.jsp">Registrar Venta</a>
                    </div>
                </div>
            </li>
            -->
            ...
            <!-- Nav Item - Pages Collapse Menu -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="ComprasDelMesServlet">
            ...
            <!-- Nav Item - Charts -->
            <li class="nav-item">
                <a class="nav-link" href="ProductosMasVendidosServlet">
                    <i class="fas fa-fw fa-chart-area"></i>
                    <span>Productos más vendidos y menos vendidos</span></a>
            </li>

            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="GananciasDelMesServlet">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Ganancias del mes</span></a>
            </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item text-center small text-gray-500" href="../Chat.jsp">Chatear</a>
                            </div>
                        </li>
