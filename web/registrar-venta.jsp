...
<p class="mb-4">A continuación podrá realizar el registro de la venta</p>

<form class="user" action="SvUsuarios" method="post">
    <p>${message}</p>

    <div class="form-group">
        <input type="text" class="form-control form-control-user" id="cliente" name="cliente"
    ...
    <button class="btn btn-success btn-user btn-block" type="submit">Registrar Venta</button>
    <hr>
</form>
